...
<div id="g_content">
	...
	<div class="g_pagelabel">
		...
		<div class="g_pagelabel_text">Colors</div>
		<?php echo $pagination; ?>
	</div>
...
$(function(){
	...
	$("#addAttr").click(function(e) {
		...
		if (validate_form("formAttr")) {
			$.ajax({
				url: "<?php echo base_url(); ?>admin/gadgets/process_add_colors",
				type: "POST",
				data: $("#formAttr").serialize(),
				success: function(response, textStatus, jqXHR){
					setTimeout(function () {
						$("#middle_wrapper").html(response);
						if (typeof history.pushState != 'undefined') { window.history.pushState("object or string", "Title", "<?php echo base_url(); ?>admin/gadgets/view_gadget_colors"); }
						displayNotification("success", "New color successfully added.");
					}, 500);
				},
