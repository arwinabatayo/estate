<div id="g_side">
	...
	<div id="menu">
		...
		<?php if ($sess_user['user_type'] <= ROLE_SUPER_ADMIN) { ?><a class="<?php echo ($page == 'users') ? "active" : ""; ?>" href="<?php echo base_url(); ?>admin/store">Store<img src="<?php echo base_url(); ?>_assets/images/menu/users.png" title="Users" /></a><?php } ?>
