...
<div id="g_filter">
<form id="form_filter_mainplantypes" class="g_form">
	
	<!-- label -->
	<?php if ($labels) { ?>
	<div class="item h_floatleft h_margin0 h_marginright8">
		<div class="label h_widthauto h_paddingright10">Main plan type</div>
		<div class="input">
...
$(".filter_button").click(function(){ 
	...
	$.ajax({
		url: "<?php echo base_url(); ?>admin/mainplantypes/process_items",
		type: "POST",
		data: $("#form_filter_mainplantypes").serialize(),
