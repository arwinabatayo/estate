...
var Grid = (function() {
	...
	Preview.prototype = {
		create : function() {
			...
			this.$title = $( '<div class="center "></div>' );
			...
			this.$href = $( '<a href="#">ruin</a>' );
			this.$details = $( '<div class="og-details"></div>' ).append( this.$getPeso, this.$cashOut);
		...
		calcHeight : function() {
			...
			var heightPreview = this.$item.data( 'height' ) - marginExpanded,
				itemHeight = settings.minHeight- this.$item.data( 'height' ) - marginExpanded - 10;

			/*
			if( heightPreview < settings.minHeight ) {
				heightPreview = settings.minHeight;
				//itemHeight = settings.minHeight + this.$item.data( 'height' ) + marginExpanded;
				itemHeight = settings.minHeight + marginExpanded;
			}
			*/
